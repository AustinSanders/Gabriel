...
class KlaxRectVisualizationArchitecture
{
	public KlaxRectVisualizationArchitecture( String name )
	{
		...
		Identifier NextTileLogic1Id = new SimpleIdentifier("NextTileLogic1");
		Identifier TileRectArtist1Id = new SimpleIdentifier("TileRectArtist1");
		...
		try
		{
			...
			controller.addBrick(new JavaClassBrickDescription("c2demo.klax.ChuteComponent"),
				ChuteComponent1Id);
			controller.addBrick(new JavaClassBrickDescription("c2demo.klax.MatchingLogic"),
				MatchingLogic1Id);
			controller.addBrick(new JavaClassBrickDescription("c2demo.klax.StatusLogic"),
				StatusLogic1Id);
			controller.addBrick(new JavaClassBrickDescription("c2demo.klax.NextTileLogic"),
				NextTileLogic1Id);
			...
			controller.addBrick(new JavaClassBrickDescription("c2demo.klax.PaletteArtist"),
				PaletteArtist1Id);
			controller.addBrick(new JavaClassBrickDescription("c2demo.klax.TileRectArtist"),
				TileRectArtist1Id);
		...
		controller.addWeld(c2.legacy.Utils.createC2Weld(bus1Id, NextTileLogic1Id));
		...
		controller.addWeld(c2.legacy.Utils.createC2Weld(bus4Id, TileRectArtist1Id));
		
		controller.addWeld(c2.legacy.Utils.createC2Weld(TileRectArtist1Id, bus5Id));
		...
		controller.begin(NextTileLogic1Id);
		controller.begin(TileRectArtist1Id);
...
public class KlaxRectVisualization extends Applet
{
	static public void main(String argv[])
	{
		KlaxRectVisualizationArchitecture sv_arch =
			new KlaxRectVisualizationArchitecture("KlaxRectVisualizationArchitecture");
	}
