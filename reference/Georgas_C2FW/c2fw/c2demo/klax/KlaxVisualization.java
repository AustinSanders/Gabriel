...
class KlaxVisualizationArchitecture
{
	public KlaxVisualizationArchitecture( String name )
	{
		...
		Identifier TileArtist1Id = new SimpleIdentifier("TileArtist1");
		...
		try
		{
			...
			controller.addBrick(new JavaClassBrickDescription("c2demo.klax.PaletteArtist"),
				PaletteArtist1Id);
			controller.addBrick(new JavaClassBrickDescription("c2demo.klax.TileArtist"),
				TileArtist1Id);
		...
		controller.addWeld(c2.legacy.Utils.createC2Weld(bus4Id, TileArtist1Id));
		
		controller.addWeld(c2.legacy.Utils.createC2Weld(TileArtist1Id, bus5Id));
		...
		controller.begin(TileArtist1Id);
...
public class KlaxVisualization extends Applet
{
	static public void main(String argv[])
	{
		KlaxVisualizationArchitecture sv_arch =
			new KlaxVisualizationArchitecture("KlaxVisualizationArchitecture");
	}
